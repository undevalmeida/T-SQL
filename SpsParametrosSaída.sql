...
SELECT COUNT(*) AS [NUMERO DE NOTAS FISCAIS - 2016] FROM [NOTAS FISCAIS] WHERE CPF = '19290992743'
AND YEAR([DATA]) = 2016

SELECT SUM(QUANTIDADE * [PREÇO]) AS [VALOR DE FATURAMENTO 2016] FROM [ITENS NOTAS FISCAIS] B
...
SELECT @NUMERO_NOTAS AS [NUMERO DE NOTAS FISCAIS], @FATURAMENTO AS FATURAMENTO